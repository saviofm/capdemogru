sap.ui.define([
	...
	return Opa5.extend("capdemogru.app.uld.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["capdemogru/app/uld/localService/mockserver"], function (mockserver) {
