		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Recebimento",
									"targetURL": "#capdemogruappuld-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"capdemogruappuld-display": {
								"semanticObject": "capdemogruappuld",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=capdemogru.app.uld",
									"url": sap.ui.require.toUrl("capdemogru/app/uld")
								}
							}
						}
					}
