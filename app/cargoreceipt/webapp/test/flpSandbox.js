		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Carga",
									"targetURL": "#capdemogruappcargoreceipt-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"capdemogruappcargoreceipt-display": {
								"semanticObject": "capdemogruappcargoreceipt",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=capdemogru.app.cargoreceipt",
									"url": sap.ui.require.toUrl("capdemogru/app/cargoreceipt")
								}
							}
						}
					}
