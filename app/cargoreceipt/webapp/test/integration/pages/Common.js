sap.ui.define([
	...
	return Opa5.extend("capdemogru.app.cargoreceipt.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["capdemogru/app/cargoreceipt/localService/mockserver"], function (mockserver) {
